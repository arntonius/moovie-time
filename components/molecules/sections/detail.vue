<template>
  <div class="relative">
        ...
        <div class="w-full max-w-7xl mx-auto px-7 z-10 h-112">
          <div class="flex">
            ...
            <div class="ml-8">
              ...
              <p class="text-sm text-white pt-1">{{ dataDetail.category }}</p>
              <div class="flex items-center h-20 mt-5">
                <div class="flex items-center px-8 border-r-2 border-gray-400">
                  <font-awesome-icon
                    ref="chartIcon"
                    :icon="['fa', 'star']"
                    class="text-yellow-primary pr-1.5 text-3xl inline-block"
                  />
    ...
    <div class="bg-white w-full h-full flex mt-40">
      <div class="w-full max-w-7xl mx-auto px-7" v-if="dataReview.length !== 0">
